...
public class ProductController {
	...
	@DeleteMapping("delete/{adminKey}/{productId}")
	public ResponseEntity<String> deleteProductByIdHandler
	(@PathVariable("adminKey") String adminKey,@PathVariable("productId") Long productId)
			throws ProductNotFoundException,AdminNotFoundException{
		return new ResponseEntity<String>(productService.deleteProductByI(productId, adminKey),HttpStatus.ACCEPTED);
	}
